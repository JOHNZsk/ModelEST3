...
implementation
  ...
  begin
    Form1.VypisChybu('Chyba pri naèítaní konfigurácie: '+p_text);
  ...
  begin
    ...
    else Result:=Chyba('Chybná ko¾ajová èiara è. '+IntToStr(p_poradie));
  end;
  ...
  begin
    ...
    else Result:=Chyba('Chybné vchodové návestidlo è. '+IntToStr(p_poradie));
  end;
  ...
  begin
    ...
    else Result:=Chyba('Chybná výhybka è. '+IntToStr(p_poradie));
  end;
  ...
  begin
    ...
    else Result:=Chyba('Chybné odchodové návestidlo è. '+IntToStr(p_poradie));    
  end;
  ...
  begin
    ...
    else Result:=Chyba('Chybné položka textu è. '+IntToStr(p_poradie));    
  end;
  ...
  begin
    ...
    else Result:=Chyba('Chybný šulibrk è. '+IntToStr(p_poradie));    
  end;
  ...
  begin
    ...
    else Result:=Chyba('Neplatný zdroj è. '+IntToStr(p_poradie_zdroj)+' v cestì è. '+IntToStr(p_poradie));  
  end;
  ...
  begin
    ...
    else Result:=Chyba('Neplatný zdroj è. '+IntToStr(p_poradie_ciel)+' v cestì è. '+IntToStr(p_poradie));
  end;
  ...
  begin
    ...
    else Result:=Chyba('Neplatný ko¾aj è. '+IntToStr(p_poradie_kolaj)+' v ceste è. '+IntToStr(p_poradie));
  end;
  ...
  begin
    ...
    else Result:=Chyba('Neplatná výhybka è. '+IntToStr(p_poradie_vyhybka)+' v ceste è. '+IntToStr(p_poradie));
  end;
  ...
  begin
    ...
    else Result:=Chyba('Neplatný zdroj è. '+IntToStr(p_poradie_zdroj)+' v makre è. '+IntToStr(p_poradie));
  end;
  ...
  begin
    ...
    else Result:=Chyba('Neplatný zdroj è. '+IntToStr(p_poradie_ciel)+' v makre è. '+IntToStr(p_poradie));
  end;
  ...
  begin
    ...
    else Result:=Chyba('Neplatná dielèia cesta è. '+IntToStr(p_poradie_ciel)+' v makre è. '+IntToStr(p_poradie));
  end;
